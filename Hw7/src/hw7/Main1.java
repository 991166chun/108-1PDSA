...
public class Main1 {
    ...
    private int buildTree(){
        ...
        while(1 < N) {
            ...
            if (!points[P.a].del() && !points[P.b].del()) {
                ...
                merges.enqueue(new clusing(P.a, P.b, newid));
                points[P.a].delete();
                N--;
                points[P.b].delete();
                N--;
    ...
    private class PointW implements Comparable<PointW> {
        ...
        public PointW centoid(PointW that) {
            ...
            PointW parent = new PointW(nx, ny, nw);
            return parent;
        }
    ...
    private class clusing {
        private final int a, b, c;         // id of the points
        public clusing(int a, int b, int c) {
                    this.a = a;
                    this.b = b;
                    this.c = c;
                }
